...
| `PacketTable.razor`           | Live table of packets currently in-flight, showing source, destination, next-hop device, and remaining TTL.                                                                                        |
...
| `BenchmarkConfigModal.razor`  | Benchmark scenario composer. Allows adding devices, scheduling events, setting duration and engine config, and choosing routers to compare.                                                        |
